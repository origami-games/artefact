...
#actions
execute if score @s food_bar matches 4.. if score state spells matches 3.. at @p[tag=primary] run function origami-games:artefact/api/spells/activate_action

#reset
execute if score state spells matches 3.. run function origami-games:artefact/api/spells/reset_activation
