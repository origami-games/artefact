#spell visual
#@s - primary player
#called by origami-games:artefact/api/spells/action/submerge
...
fill ~1 ~2 ~ ~1 ~2 ~ minecraft:packed_ice replace #origami-games:artefact/api/spells/action/submerge/block
fill ~-1 ~2 ~-1 ~-1 ~2 ~-1 minecraft:packed_ice replace #origami-games:artefact/api/spells/action/submerge/block
fill ~-1 ~2 ~1 ~-1 ~2 ~1 minecraft:blue_ice replace #origami-games:artefact/api/spells/action/submerge/block
