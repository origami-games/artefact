...
execute store result bossbar artefact-api:abilities/energy_sucker_punch/timer value run scoreboard players get esp.timer abilities
#boss bar visibility
bossbar set artefact-api:abilities/energy_sucker_punch/timer visible true
