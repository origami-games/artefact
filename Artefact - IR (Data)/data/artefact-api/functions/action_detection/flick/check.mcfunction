...
execute if score rot_y flick_math matches ..-40 if score rot_y.operate flick_math >= threshold flick_math run function artefact-api:action_detection/flick/execute
