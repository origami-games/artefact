...
tellraw @s {"text":"- Zombie (Goblin)","color":"gold","clickEvent":{"action":"run_command","value":"/function artefact-api:entities/spawn/zombie/goblin"},"hoverEvent":{"action":"show_text","value":"artefact-api:entities/zombie/goblin"}}
tellraw @s ""
