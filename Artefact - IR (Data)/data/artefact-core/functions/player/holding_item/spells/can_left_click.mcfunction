...
execute if entity @s[scores={left_click=10..}] unless score cooldown spells matches 1.. if score left_click_health general < left_click_health.prev general run function artefact-api:spells/click/left
