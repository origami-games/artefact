...
execute unless entity @s[nbt={Inventory:[{Slot:1b,tag:{artefact:{is_hotbar_item:1b,hotbar_item:1b}}}]}] run function artefact-core:player/hotbar/remove/1
execute unless entity @s[nbt={Inventory:[{Slot:2b,tag:{artefact:{is_hotbar_item:1b,hotbar_item:2b}}}]}] run function artefact-core:player/hotbar/remove/2
execute unless entity @s[nbt={Inventory:[{Slot:3b,tag:{artefact:{is_hotbar_item:1b,hotbar_item:3b}}}]}] run function artefact-core:player/hotbar/remove/3
