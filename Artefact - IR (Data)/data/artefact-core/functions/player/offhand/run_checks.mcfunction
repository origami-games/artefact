...
execute if score total_attributed offhand_counts matches 1 if entity @s[nbt=!{Inventory:[{Slot:-106b,id:"minecraft:shield"}]}] run function artefact-core:player/offhand/clear_shield_attributes
