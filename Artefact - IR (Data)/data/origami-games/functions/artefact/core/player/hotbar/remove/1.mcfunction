...
execute if entity @s[nbt={Inventory:[{Slot:1b}]}] run summon minecraft:item ~ ~ ~ {Item:{id:"minecraft:stick",Count:1b,tag:{CustomModelData:1,artefact:{hotbar_replacement:1b}}},Tags:["slot.1","no_pickup"],Owner:{L:1,M:2}}
data modify entity @e[type=minecraft:item,tag=slot.1,sort=nearest,limit=1] Owner.L set from entity @s UUIDLeast
data modify entity @e[type=minecraft:item,tag=slot.1,sort=nearest,limit=1] Owner.M set from entity @s UUIDMost
data modify entity @e[type=minecraft:item,tag=slot.1,sort=nearest,limit=1] Item merge from entity @s Inventory[{Slot:1b}]
data remove entity @e[type=minecraft:item,tag=slot.1,sort=nearest,limit=1,nbt={Item:{tag:{CustomModelData:1,id:"minecraft:stick",artefact:{hotbar_replacement:1b}}}}] Item.tag.CustomModelData
